...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Saint Vincent Parish</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_content">
                ...
                <main  class="tabcontent" id="marriage">
                 ...
                 <main  class="tabcontent" id="login">
                  ...
                  <main  class="tabcontent" id="register">
                    <div class="container-fluid px-4">
                ...
                <main  class="tabcontent" id="password">
                    <div class="container-fluid px-4">
                ...
                <main id="tables" class="tabcontent">
                    <div class="container-fluid px-4">
