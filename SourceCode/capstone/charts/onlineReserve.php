<?php 
  ...
  $query1 = "SELECT COUNT(*) AS countOnline FROM baptismal_tbl WHERE transactType = 'Online'AND MONTH(tDate) = $selectedMonth AND YEAR(tDate) = $selectedYear";
	...
	$query3 = "SELECT COUNT(*) AS countOnline FROM communion_tbl WHERE transactType = 'Online'AND MONTH(transactDate) = $selectedMonth AND YEAR(transactDate) = $selectedYear";
