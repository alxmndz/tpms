<div class="container" style="margin-top: 10px;">
  <div class="card mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive">
        <table class="table table-striped" id="blessTbl" style="margin-top: 10px;">
          <?php
          ...
          <tbody id="searchResults4">
            ...
            <tr>
              ...
              <td>
                <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#blessView<?php echo $row['id']; ?>"> <i class="fa-solid fa-eye"></i>
                </button>
                <?php
                  if ($row['status'] === 'Approved' && empty($row['refNum']) && empty($row['amount']) && empty($row['receipt'])) {
                  ?>
                      <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#payBless<?php echo $row['id']; ?>">
 ...
 <div class="modal fade" id="payBless<?php echo $row['id']; ?>">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Blessing Payment Form</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <form action="php/payBless.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="row my-3">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <input type="number" class="form-control" id="inputNumber" name="amount" value="<?php echo $blessing; ?>" readonly required>
                    </div>
                    <div class="mb-3">
          ...
          <div class="col-md-6 ms-auto">
            ...
            <div class="modal fade" id="blessView<?php echo $row['id']; ?>">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
