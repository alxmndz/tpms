                          ...
                          <div class="row my-3">
                            <div class="col-md-6">
                                  <div class="form-outline">
                                      ...
                                      <input class="form-control" type="date" id="conDate" name="conDate" value="<?php echo $row['conDate']; ?>" required readonly>
                                  </div>
                              </div>
                              <div class="col-md-6">
                                   <div class="form-outline">
                                      <label class="form-label" for="typeText"><i class="fa-solid fa-clock"></i> Blessing Time</label>
                                      <input class="form-control" type="time" id="conTime" name="conTime" value="<?php echo $row['conTime']; ?>" required readonly>
                                  </div>
                            </div>
                          </div>
                          <div class="row my-3">
