        ...
        <table class="table table-striped" id="onCommTable" style="margin-top: 10px;">
          ...
          <tbody id="searchResults5">
            ...
            <tr>
              ...
              <td>
                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#viewComm<?php echo $row['id']; ?>"><i class="fa-solid fa-eye"></i> View
                </button>
              </td>
            </tr>

            <div class="modal modal-lg fade" id="viewComm<?php echo $row['id']; ?>">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">View Communion Reservation</h4>
