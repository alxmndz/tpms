  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive">
        <table class="table table-striped" id="onBlessTable" style="margin-top: 10px;">
          <?php
          ...
          <tbody id="searchResults3">
            ...
            <tr>
              ...
              <td>
                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#viewBless<?php echo $row['id']; ?>"><i class="fa-solid fa-eye"></i> View
                </button>
              </td>
            </tr>

  <div class="modal modal-lg fade" id="viewBless<?php echo $row['id']; ?>">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">View Blessing Reservation</h4>
    ...
    <script>
      $(document).ready(function(){
          ...
          var table = $('#onBlessTable').DataTable({
