<?php
  ...
  $month = 8; // Assuming you want to fetch data for January
  $baptismCount = 0;
  $blessingCount = 0;
  $communionCount = 0;
  $confirmationCount = 0;
  ...
  $baptismCountAug = $data1['countsReserved1'];
  $blessingCountAug = $data2['countsReserved2'];
  $communionCountAug = $data3['countsReserved3'];
  $confirmationCountAug = $data4['countsReserved4'];
  $funeralMassCountAug = $data5['countsReserved5'];
  $weddingCountAug = $data6['countsReserved6'];
?>