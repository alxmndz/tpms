<?php
  ...
  $month = 12; // Assuming you want to fetch data for January
  $baptismCount = 0;
  $blessingCount = 0;
  $communionCount = 0;
  $confirmationCount = 0;
  ...
  $baptismCountDec = $data1['countsReserved1'];
  $blessingCountDec = $data2['countsReserved2'];
  $communionCountDec = $data3['countsReserved3'];
  $confirmationCountDec = $data4['countsReserved4'];
  $funeralMassCountDec = $data5['countsReserved5'];
  $weddingCountDec = $data6['countsReserved6'];
?>