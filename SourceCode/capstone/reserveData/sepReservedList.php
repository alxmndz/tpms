<?php
  ...
  $month = 9; // Assuming you want to fetch data for January
  $baptismCount = 0;
  $blessingCount = 0;
  $communionCount = 0;
  $confirmationCount = 0;
  ...
  $baptismCountSep = $data1['countsReserved1'];
  $blessingCountSep = $data2['countsReserved2'];
  $communionCountSep = $data3['countsReserved3'];
  $confirmationCountSep = $data4['countsReserved4'];
  $funeralMassCountSep = $data5['countsReserved5'];
  $weddingCountSep = $data6['countsReserved6'];
?>