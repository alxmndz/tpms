<?php
  ...
  $month = 2; // Assuming you want to fetch data for January
  $baptismCount = 0;
  $blessingCount = 0;
  $communionCount = 0;
  $confirmationCount = 0;
  ...
  $baptismCountFeb = $data1['countsReserved1'];
  $blessingCountFeb = $data2['countsReserved2'];
  $communionCountFeb = $data3['countsReserved3'];
  $confirmationCountFeb = $data4['countsReserved4'];
  $funeralMassCountFeb = $data5['countsReserved5'];
  $weddingCountFeb = $data6['countsReserved6'];
?>
