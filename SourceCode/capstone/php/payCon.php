...
if (isset($_POST['btn-save'])) {
    ...
    $sql_query = "UPDATE confirmation_tbl SET payMethod='$payMethod', amount='$amount', payDate='$payDate', status='$status', receipt='$targetFilePath', refNum='$refNum' WHERE id='$id'";
