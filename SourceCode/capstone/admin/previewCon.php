              ...
              <div class="certificate" style="border: 2px solid black; padding: 100px;">
                  ...
                  <div class="certificate-content" style="margin-top: 30px;">
                    ...
                    <div class="mt-3">
                      ...
                      <p>has received</p>
                      <h4><b style="font-family: 'Old English Five', sans-serif;" class="mt-3">The Holy Sacrament of Confirmation</b></h4>
                      ...
                      <div class="mt-5">
                        <p>As appears on the Confirmation Register No. <?php echo $row['id']; ?> of this church.</p>
                      </div>
                    </div>
                  </div>
