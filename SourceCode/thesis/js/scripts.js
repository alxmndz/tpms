        ...
        success: function (response) {//once the request successfully process to the server side it will return result here
            ...
            if(response.length) {
                ...
                $.each(response, function(key,value) {
                    ...
                    html += "<p>" + value.fname +' '+ value.lname + " <span class='list-email'>(" + value.email + ")</span>" + "</p>";
                    html += "<p class='list-address'>" + value.type + "</p>";
...
function get() 
{
    $(document).delegate("[data-target='#edit-reports']", "click", function() {
