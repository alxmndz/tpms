...
if (count($_POST) > 0) {
  ...
  if ($valid) {
    mysqli_query($conn, "UPDATE forms SET fname='" . $_POST['fname'] . "', lname ='" . $_POST['lname'] . "', address ='" . $_POST['address'] . "', mobilePhone ='" . $_POST['mobilePhone'] . "', email ='" . $_POST['email'] . "', formType ='" . $_POST['formType'] . "', refNum ='" . $_POST['refNum'] . "', amount ='" . $_POST['amount'] . "'  WHERE formsID='" . $_POST['formsID'] . "'");
