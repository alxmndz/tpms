<div class="container py-5">
  <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addRes1" name="btn-save" id="btn-save myBtn" style="float: right; margin-bottom: 15px;"><i class="fa-solid fa-plus"></i> Add Reservation</button>
  <table class="table table-bordered text-center" style="color: black;">
    ...
    <tr class="text-center">
      ...
      <td>
        <a href="php/reserve/edit1.php?eventResID=<?php echo $row["eventResID"]; ?>">
      ...
      <td>
        <a href="php/reserve/delete1.php?eventResID=<?php echo $row["eventResID"]; ?>">
