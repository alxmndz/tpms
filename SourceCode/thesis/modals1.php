<div class="modal fade" id="addForms1">
        ...
        <div class="modal fade" id="addReport1">
          <div class="modal-dialog ">
            <div class="modal-content">
              <section>
                <div class="container">
                  <div class="row justify-content-center align-items-center h-100">
                    ...
                    <div class="card-body">
                      <h4>Report</h4>
                      <hr>
                      <form class="" action="php/report/save1.php" method="post">
                            <div class="md-3">
                              <p>
          ...
          <div class="modal fade" id="addAnnounce1" >
            <div class="container">
              <div class="modal-dialog">
                 <div class="modal-content">
                   <section>
                                   ...
                                   <div class="row align-items-center h-100">
                                     <div class="card container h-100" style="background: #FFFFFF;">
                                      ...
                                      <div class="card-body">
                                        <h4>Announcements</h4>
                                        <hr>
                                        <form class="" action="php/announcement/save1.php" method="POST">
        ...
        <div class="modal fade" id="addRes1">
          <div class="modal-dialog ">
            <div class="modal-content">
              <section>
                <div class="container">
