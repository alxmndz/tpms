        ...
        <div class="row">
            <div class="col-md-4">
                <div class="image-card">
                    ...
                    <h3>Baptismal</h3>
                    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#bapModal">Reserve</button>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="image-card">
                    ...
                    <h3>Blessing</h3>
                    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#bless">Reserve</button>
                </div>
            </div>
