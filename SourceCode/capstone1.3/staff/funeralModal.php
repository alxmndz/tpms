  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="php/saveFuneralST.php" method="POST" enctype="multipart/form-data" autocomplete="off">
              <div class="row my-3">
                <div class="col-md-12">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="inputNumber4" name="amount" value="1500" readonly required>
                  </div>
                  <div class="mb-3">
