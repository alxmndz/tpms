...
<div class="container px-4" style="margin-top: 20px;">
	<div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <div class="ms-auto">
                      <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#donateModal"><i class="fa-solid fa-hand-holding-dollar"></i></button>
                    </div>
                </div>
           <div class="card-body">
              <div class="table-responsive">
                <table class="table table-striped" id="donateTbl">
                    <?php
