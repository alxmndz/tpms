<?php
  ...
  // Fetch data for January only
  $month = 4; // Assuming you want to fetch data for January
  $baptismCount = 0;
  $blessingCount = 0;
  $communionCount = 0;
  $confirmationCount = 0;
  ...
  $baptismCountApr = $data1['countsReserved1'];
  $blessingCountApr = $data2['countsReserved2'];
  $communionCountApr = $data3['countsReserved3'];
  $confirmationCountApr = $data4['countsReserved4'];
  $funeralMassCountApr = $data5['countsReserved5'];
  $weddingCountApr = $data6['countsReserved6'];
?>