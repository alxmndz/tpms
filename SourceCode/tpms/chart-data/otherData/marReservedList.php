<?php
  ...
  $month = 3; // Assuming you want to fetch data for January
  $baptismCount = 0;
  $blessingCount = 0;
  $communionCount = 0;
  $confirmationCount = 0;
  ...
  $baptismCountMar = $data1['countsReserved1'];
  $blessingCountMar = $data2['countsReserved2'];
  $communionCountMar = $data3['countsReserved3'];
  $confirmationCountMar = $data4['countsReserved4'];
  $funeralMassCountMar = $data5['countsReserved5'];
  $weddingCountMar = $data6['countsReserved6'];
?>
