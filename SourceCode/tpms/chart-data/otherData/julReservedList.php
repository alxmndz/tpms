<?php
  ...
  $month = 7; // Assuming you want to fetch data for January
  $baptismCount = 0;
  $blessingCount = 0;
  $communionCount = 0;
  $confirmationCount = 0;
  ...
  $baptismCountJul = $data1['countsReserved1'];
  $blessingCountJul = $data2['countsReserved2'];
  $communionCountJul = $data3['countsReserved3'];
  $confirmationCountJul = $data4['countsReserved4'];
  $funeralMassCountJul = $data5['countsReserved5'];
  $weddingCountJul = $data6['countsReserved6'];
?>