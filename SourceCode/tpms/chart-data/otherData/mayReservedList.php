<?php
  ...
  // Fetch data for January only
  $month = 5; // Assuming you want to fetch data for January
  $baptismCount = 0;
  $blessingCount = 0;
  $communionCount = 0;
  $confirmationCount = 0;
  ...
  $baptismCountMay = $data1['countsReserved1'];
  $blessingCountMay = $data2['countsReserved2'];
  $communionCountMay = $data3['countsReserved3'];
  $confirmationCountMay = $data4['countsReserved4'];
  $funeralMassCountMay = $data5['countsReserved5'];
  $weddingCountMay = $data6['countsReserved6'];
?>