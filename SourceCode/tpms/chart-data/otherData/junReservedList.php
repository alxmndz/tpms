<?php
  ...
  // Fetch data for January only
  $month = 6; // Assuming you want to fetch data for January
  $baptismCount = 0;
  $blessingCount = 0;
  $communionCount = 0;
  $confirmationCount = 0;
  ...
  $baptismCountJun = $data1['countsReserved1'];
  $blessingCountJun = $data2['countsReserved2'];
  $communionCountJun = $data3['countsReserved3'];
  $confirmationCountJun = $data4['countsReserved4'];
  $funeralMassCountJun = $data5['countsReserved5'];
  $weddingCountJun = $data6['countsReserved6'];
?>