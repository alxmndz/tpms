<?php
  ...
  $month = 10; // Assuming you want to fetch data for January
  $baptismCount = 0;
  $blessingCount = 0;
  $communionCount = 0;
  $confirmationCount = 0;
  ...
  $baptismCountOct = $data1['countsReserved1'];
  $blessingCountOct = $data2['countsReserved2'];
  $communionCountOct = $data3['countsReserved3'];
  $confirmationCountOct = $data4['countsReserved4'];
  $funeralMassCountOct = $data5['countsReserved5'];
  $weddingCountOct = $data6['countsReserved6'];
?>