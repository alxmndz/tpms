...
if (isset($_POST['btn-save'])) {
    ...
    if ($payMethod === 'face-to-face') {
        ...
        if ($status === 'Ready to pick up') {
            ...
            mysqli_query($conn, "INSERT INTO request(addedBy, name, contact, address, event, amount, refNum, receipt, transactType, transactDate, whenToPickUp) VALUES ('$addedBy', '$name', '$contact', '$address', '$event', '$amount', '$refNum', '$targetFilePath', '$transactType', '$transactDate', '{$whenToPickUp->format('Y-m-d H:i:s')}')");
        }
        ...
        if ($status === 'Released') {
            ...
            mysqli_query($conn, "INSERT INTO request(addedBy, name, contact, address, event, amount, refNum, receipt, transactType, transactDate, whenToPickUp, pickUpDt) VALUES ('$addedBy', '$name', '$contact', '$address', '$event', '$amount', '$refNum', '$targetFilePath', '$transactType', '$transactDate', '$formattedTimestamp', '$formattedTimestamp')");
        }

        if ($status === 'In Process') {
            mysqli_query($conn, "INSERT INTO request(addedBy, name, contact, address, event, amount, refNum, receipt, transactType, transactDate) VALUES ('$addedBy', '$name', '$contact', '$address', '$event', '$amount', '$refNum', '$targetFilePath', '$transactType', '$transactDate')");
        }
