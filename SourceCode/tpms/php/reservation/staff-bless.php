...
if (isset($_POST['btn-save'])) {
    ...
    $sql_query = "INSERT INTO blessing_tbl(name,contact,address,blessDate,blessTime,intention,amount,addedBy,receipt,transactType, refNum, payMethod, payDate, transactDate) VALUES('$name','$contact','$address','$blessDate','$blessTime','$intention','$amount','$addedBy','$targetFilePath','$transactType','$refNum','$payMethod', '$payDate','$transactDate')";
