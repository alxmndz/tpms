<?php
  ...
  if (count($_POST) > 0) {
    ...
    $id = $_POST['id'];
      ...
      mysqli_query($conn, "UPDATE wedding_tbl SET birthCert='$birthCert', bapCert='$bapCert', conCert='$conCert', cenomar='$cenomar', marriageLicense='$marriageLicense', RPic='$RPic', MBPic='$MBPic',status='$status' WHERE id='$id'");
  ...
  header('Location: ../../admin/walk-in/wedding.php');
  exit();
  }
