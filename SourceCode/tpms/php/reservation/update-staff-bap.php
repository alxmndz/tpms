<?php
  ...
  if (count($_POST) > 0) {
    ...
    $id = $_POST['id'];
      ...
      mysqli_query($conn, "UPDATE baptismal_tbl SET birthCert='$birthCert',marriageCont='$marriageCont',sponsor1='$sponsor1',sponsor2='$sponsor2' WHERE id='$id'");
  ...
  header('Location: ../../staff/walk-in/baptismal.php');
  exit();
  }
