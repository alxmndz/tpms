		...
		<li class="nav-item">
            ...
            <div class="collapse" id="online-reserve">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a class="nav-link nav-link-custom active" href="confirmation.html"> Confirmation</a></li>
...
<div id="content">
    ...
    <div class="row">
        <div class="col-md-6">
            <p><span class="text-muted">Admin > Online ></span> Confirmation</p>
        </div>
