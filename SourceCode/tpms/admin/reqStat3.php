                      ...
                      <div class="modal-body">
                          <div class="row">
                              ...
                              <div class="col-md-6">
                                  ...
                                  <p><strong>Confirmation Date:</strong> <?php echo date("M-d-y", strtotime($row["conDate"])); ?></p>
                                  <p><strong>Confirmation Time:</strong> <?php echo date("h:i A", strtotime($row["conTime"])); ?></p>
