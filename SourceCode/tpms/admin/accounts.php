...
?>
    <div id="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link nav-link-custom active" href="accounts.php"><i class="fas fa-users"></i> Accounts</a>
            </li>
            <li class="nav-item">
...
<div id="content">
    ...
    <div class="row">
        <div class="col-md-6">
            <p><span class="text-muted">Admin ></span> Accounts</p>
        </div>
                ...
                <tr>
                    <td class="align-middle">
                        <div class="profile-picture">
                            <img src="../assets/profile/<?php echo $row["profile"]; ?>" alt="Profile Picture" class="img-thumbnail">
                        </div>
                    </td>
