        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="walkIn-reserve">
                <ul class="nav flex-column">
					...
					<li class="nav-item nav-link-custom active"><a class="nav-link" href="funeralmass.php"> Funeral Mass</a></li>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <!-- Right Side (Form) -->
                        <div class="col-md-6">
                    <form action="../../php/reservation/update-funeral.php" method="post" enctype="multipart/form-data" autocomplete="off">
