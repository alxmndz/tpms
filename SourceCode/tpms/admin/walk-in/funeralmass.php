        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="walkIn-reserve">
                <ul class="nav flex-column">
					...
					<li class="nav-item nav-link-custom active"><a class="nav-link" href="funeralmass.html"> Funeral Mass</a></li>
...
<div id="content">
    ...
    <div class="row">
        <div class="col-md-6">
            <p><span class="text-muted">Admin > Walk-In ></span> Funeral Mass </p>
        </div>
