        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="walkIn-reserve">
                <ul class="nav flex-column">
					...
					<li class="nav-item"><a class="nav-link" href="communion.html"> Communion</a></li>
                    <li class="nav-item nav-link-custom active"><a class="nav-link" href="confirmation.html"> Confirmation</a></li>
...
<div id="content">
    ...
    <div class="row">
        <div class="col-md-6">
            <p><span class="text-muted">Admin > Walk-In ></span> Confirmation </p>
        </div>
