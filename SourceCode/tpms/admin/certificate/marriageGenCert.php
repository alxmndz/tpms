		...
		<li class="nav-item">
            ...
            <div class="collapse" id="cert">
                <ul class="nav flex-column">
					...
					<li class="nav-item nav-link-custom active"><a class="nav-link" href="marriageGenCert.html"> Marriage Certificate</a></li>
                </ul>
            </div>
        </li>
...
<div id="content">
    ...
    <div class="row">
        <div class="col-md-6">
            <p><span class="text-muted">Admin > Generate Certificate ></span> Marriage Certificate</p>
        </div>
