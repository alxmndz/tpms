    ...
    <ul class="nav flex-column">
		...
		<li class="nav-item">
            ...
            <div class="collapse" id="cert">
                <ul class="nav flex-column">
                    <li class="nav-item"><a class="nav-link" href="bapGenCert.php"> Baptismal Certificate</a></li>
                    <li class="nav-item"><a class="nav-link" href="comGenCert.php"> Communion Certificate</a></li>
					<li class="nav-item"><a class="nav-link" href="conGenCert.php"> Confirmation Certificate</a></li>
                    <li class="nav-item"><a class="nav-link" href="deathGenCert.php"> Death Certificate</a></li>
					<li class="nav-item nav-link-custom active"><a class="nav-link" href="marriageGenCert.php"> Marriage Certificate</a></li>
                </ul>
            </div>
        </li>
...
<div id="content">
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-end"> <!-- Use 'text-end' class to align text to the right -->
            <button class="view-btn" data-bs-toggle="modal" data-bs-target="#wedding">
        ...
        <?php
            ...
            <?php
                ...
                <tr>
                    ...
                    <td class="align-middle"><a class="update-btn" href="preview-marriage.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-print"></i></a></td>
                </tr>
            </tbody>
            <?php
                $i++;
