    ...
    <ul class="nav flex-column">
		...
		<li class="nav-item">
            ...
            <div class="collapse" id="cert">
                <ul class="nav flex-column">
                    <li class="nav-item"><a class="nav-link" href="bapGenCert.html"> Baptismal Certificate</a></li>
                    <li class="nav-item nav-link-custom active"><a class="nav-link" href="comGenCert.html"> Communion Certificate</a></li>
...
<div id="content">
    ...
    <div class="row">
        <div class="col-md-6">
            <p><span class="text-muted">Admin > Generate Certificate ></span> Communion Certificate</p>
        </div>
