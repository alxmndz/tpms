...
<div id="sidebar">
    ...
    <ul class="nav flex-column">
		...
		<li class="nav-item">
            <a class="nav-link nav-link-custom active" href="#" data-bs-toggle="collapse" data-bs-target="#cert">
                <i class="fas fa-caret-down"></i> Generate Certificate
            </a>
            <div class="collapse" id="cert">
                <ul class="nav flex-column">
                    <li class="nav-item nav-link-custom active"><a class="nav-link" href="bapGenCert.html"> Baptismal Certificate</a></li>
                    <li class="nav-item"><a class="nav-link" href="comGenCert.html"> Communion Certificate</a></li>
					<li class="nav-item"><a class="nav-link" href="conGenCert.html"> Confirmation Certificate</a></li>
                    <li class="nav-item"><a class="nav-link" href="deathGenCert.html"> Death Certificate</a></li>
					<li class="nav-item"><a class="nav-link" href="marriageGenCert.html"> Marriage Certificate</a></li>
                </ul>
            </div>
        </li>
		...
		<li class="nav-item">
            ...
            <div class="collapse" id="online-reserve">
                <ul class="nav flex-column">
                    <li class="nav-item"><a class="nav-link" href="../online/baptismal.html"> Baptismal</a></li>
                    <li class="nav-item"><a class="nav-link" href="../online/blessing.html"> Blessing</a></li>
					<li class="nav-item"><a class="nav-link" href="../online/communion.html"> Communion</a></li>
                    <li class="nav-item"><a class="nav-link" href="../online/confirmation.html"> Confirmation</a></li>
					<li class="nav-item"><a class="nav-link" href="../online/funeralmass.html"> Funeral Mass</a></li>
                    <li class="nav-item"><a class="nav-link" href="../online/wedding.html"> Wedding</a></li>
                    <!-- Add more items as needed -->
                </ul>
            </div>
        </li>
...
<div id="content">
    ...
    <div class="row">
        <div class="col-md-6">
            <p><span class="text-muted">Admin > Generate Certificate ></span> Baptismal Certificate</p>
        </div>
