...
<body>
	...
	<?php
		...
		$result = mysqli_query($conn,"SELECT * FROM certcon WHERE id='" . $_GET['id'] . "'");
                    ...
                    <div class="text-center">
                        <div class="row justify-content-center align-items-center">
                            ...
                            <div class="col-6 text-start">
                                <h2 class="fw-bold" style="font-family: 'TR Dauphin', sans-serif; font-size: 24px;">Confirmation Certificate</h2>
                ...
                <hr>
                  <div class="certificate-content" style="margin-top: 30px;">
                    ...
                    <div class="mt-3">
                      ...
                      <h5>has received</h5>
                      <h4><b style="font-family: 'TR Dauphin', sans-serif; font-size: 20px;" class="mt-3">The Holy Sacrament of Confirmation</b></h4>
                      ...
                      <div class="mt-5">
                        <h5>As appears on the Confirmation Register No. <?php echo $row['id']; ?> of this church.</h5>
                      </div>
                    </div>
                  </div>
...
<script type="text/javascript">
	...
	function back() {
        window.location.href = 'conGenCert.php';
    }
</script>
