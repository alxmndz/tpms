        ...
        <div class="row full-height">
            <div class="col-md-6 col-lg-5 left-column">
                <div class="d-flex justify-content-center align-items-center h-100">
                    <div class="card" style="background-color: rgba(0, 0, 0, 0.5); color: white; border: none; box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);">
                        <div class="card-header">
                            <a href="index.php"><i class="fas fa-arrow-circle-left" style="color: #48C9B0;"></i></a>
                        ...
                        <div class="card-footer text-center">
                            <span>Don't have an account yet? <a href="signup.php">Signup</a></span>
                        </div>
                    </div>
                </div>
            </div>
