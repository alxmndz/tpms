...
<div id="content">
    ...
    <div class="row">
        <div class="col-md-6">
            <p><span class="text-muted">Staff > Walk-In ></span> Confirmation </p>
        </div>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <!-- Right Side (Form) -->
                   <div class="col-md-6">
                    <form action="../../php/reservation/update-staff-confirmation.php" method="post" enctype="multipart/form-data" autocomplete="off">
                      <div class="form-group">
                          ...
                          <div class="row my-3">
                            <div class="col-md-6">
                                  <div class="form-outline">
                                      <label class="form-label" for="typeText"><i class="fa-solid fa-calendar"></i> Reserved Date</label>
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="text-center">
                                    <span class="modal-header mb-3 text-center fw-bold" style="text-transform:uppercase;"><strong>Confirmation Requirements</strong></span>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
