...
<div id="content">
    ...
    <div class="row">
        <div class="col-md-6">
            <p><span class="text-muted">Staff > Walk-In ></span> Baptismal </p>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <!-- Right Side (Form) -->
                    <div class="col-md-6">
                        <form action="../../php/reservation/update-staff-bap.php" method="post" enctype="multipart/form-data" autocomplete="off">
