        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="walkIn-reserve">
                <ul class="nav flex-column">
					...
					<li class="nav-item nav-link-custom active"><a class="nav-link" href="communion.php"> Communion</a></li>
...
<div id="content">
    ...
    <div class="row">
        <div class="col-md-6">
            <p><span class="text-muted">Staff > Walk-In ></span> Communion </p>
        </div>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <!-- Right Side (Form) -->
                        <div class="col-md-6">
                    <form action="../../php/reservation/update-staff-communion.php" method="post" enctype="multipart/form-data" autocomplete="off">
                      <div class="form-group">
                        ...
                        <div class="mb-3">
                                <div class="text-center">
                                    <span class="modal-header mb-3 text-center fw-bold" style="text-transform:uppercase;"><strong>Communion Requirements</strong></span>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
