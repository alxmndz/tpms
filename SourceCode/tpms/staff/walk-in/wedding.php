...
<div id="content">
    ...
    <div class="row">
        <div class="col-md-6">
            <p><span class="text-muted">Staff > Walk-In ></span> Wedding </p>
        </div>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <!-- Right Side (Form) -->
                        <div class="col-md-6">
                    <form action="../../php/reservation/update-staff-wedd.php" method="post" enctype="multipart/form-data" autocomplete="off">
