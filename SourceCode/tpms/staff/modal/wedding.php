  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../php/reservation/staff-wedding.php" method="POST" enctype="multipart/form-data" autocomplete="off">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-bold text-center text-uppercase">Wedding Requirements</h5>
              <table class="table">
                <tbody>
                  <tr>
                    <td>
