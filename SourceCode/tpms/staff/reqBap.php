  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive">
        <table class="table table-striped" style="margin-top: 10px;" id="datatablesSimple25">
          <?php
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <!-- Right Side (Form) -->
                    <div class="col-md-6">
                        <form action="php/updateBap2.php" method="post" enctype="multipart/form-data" autocomplete="off">
...
window.addEventListener('DOMContentLoaded', event => {
    const datatablesSimple = document.getElementById('datatablesSimple25');
    if (datatablesSimple) {
