  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive">
        <table class="table table-striped" id="datatablesSimple27" style="margin-top: 10px;">
          <?php
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <!-- Right Side (Form) -->
                        <div class="col-md-6">
                    <form action="php/updateCom2.php" method="post" enctype="multipart/form-data" autocomplete="off">
...
window.addEventListener('DOMContentLoaded', event => {
    const datatablesSimple = document.getElementById('datatablesSimple27');
    if (datatablesSimple) {
