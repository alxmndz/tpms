		...
		<li class="nav-item">
            ...
            <div class="collapse" id="cert">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item nav-link-custom active"><a class="nav-link" href="conGenCert.php"> Confirmation Certificate</a></li>
...
<div id="content">
    ...
    <div class="row">
        <div class="col-md-6">
            <p><span class="text-muted">Staff > Generate Certificate ></span> Confirmation Certificate</p>
        </div>
