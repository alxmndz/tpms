		...
		<li class="nav-item">
            ...
            <div class="collapse" id="cert">
                <ul class="nav flex-column">
					...
					<li class="nav-item"><a class="nav-link nav-link-custom active" href="comGenCert.php"> Communion Certificate</a></li>
					...
					<li class="nav-item"><a class="nav-link" href="marriageGenCert.php"> Marriage Certificate</a></li>
                </ul>
            </div>
        </li>
...
<div id="content">
    ...
    <div class="row">
        <div class="col-md-6">
            <p><span class="text-muted">Staff > Generate Certificate ></span> Communion Certificate</p>
        </div>
        <div class="col-md-6 text-end"> <!-- Use 'text-end' class to align text to the right -->
            <button class="view-btn" data-bs-toggle="modal" data-bs-target="#communion">
        ...
        <table id="example" class="display responsive nowrap table" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="align-middle"><a class="update-btn" href="preview-comm.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-print"></i></a></td>
                </tr>
                </div>
                <?php
                }
