    ...
    <ul class="nav flex-column">
		...
		<li class="nav-item">
            ...
            <div class="collapse" id="cert">
                <ul class="nav flex-column">
                    <li class="nav-item nav-link-custom active"><a class="nav-link" href="bapGenCert.php"> Baptismal Certificate</a></li>
...
<div id="content">
    ...
    <div class="row">
        <div class="col-md-6">
            <p><span class="text-muted">Staff > Generate Certificate ></span> Baptismal Certificate</p>
        </div>
        <div class="col-md-6 text-end"> <!-- Use 'text-end' class to align text to the right -->
            <button class="view-btn" data-bs-toggle="modal" data-bs-target="#baptismal">
          ...
          ?>
            ...
            ?>
                <tr>
                    ...
                    <td class="align-middle"><a class="update-btn" href="preview-bap.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-print"></i></a></td>
                </tr>
            <?php
              $i++;
              }
