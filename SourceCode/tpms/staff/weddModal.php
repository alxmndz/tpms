  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="php/saveWed2.php" method="POST" enctype="multipart/form-data" autocomplete="off">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="inputNumber5" name="amount" value="3000" readonly required>
                  </div>
                  <div class="mb-3">
