  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive">
        <table class="table table-striped" id="datatablesSimple31" style="margin-top: 10px;">
          <?php
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <!-- Right Side (Form) -->
                    <div class="col-md-6">
                        <form action="php/updateBap3.php" method="post" enctype="multipart/form-data" autocomplete="off">
...
window.addEventListener('DOMContentLoaded', event => {
    const datatablesSimple = document.getElementById('datatablesSimple31');
    if (datatablesSimple) {
