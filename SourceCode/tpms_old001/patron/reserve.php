    ...
    <div class="container" style="margin-top: 20px;">
        <div class="row">
          <div class="col-md-4 mb-4">
              ...
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <button type="button" class="btn btn-primary" onclick="openCity(event, 'baptismal')">Reserve</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 mb-4">
                    <div class="card">
                        <div class="row g-0">
              <div class="col-md-4 d-flex justify-content-center align-items-center">
                <img src="assets/img/portfolio/blessing.jpg" class="card-img" alt="Image 1">
              </div>
              <div class="col-md-8">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
                    <div class="card">
                        <div class="row g-0">
              <div class="col-md-4 d-flex justify-content-center align-items-center">
                <img src="assets/img/portfolio/communion.jpg" class="card-img" alt="Image 1">
              </div>
              <div class="col-md-8">
                <div class="card-body">
                  <h5 class="card-title">Communion</h5>
                  <p class="card-text">You declare the Lord's death until he returns.</p>
                  <button type="button" class="btn btn-primary" onclick="openCity(event, 'communion')">Reserve</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-4 mb-4">
                    <div class="card">
                        <div class="row g-0">
              <div class="col-md-4 d-flex justify-content-center align-items-center">
                <img src="assets/img/portfolio/kumpil.jpg" class="card-img" alt="Image 1">
              </div>
              <div class="col-md-8">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
                    <div class="card">
                        <div class="row g-0">
              <div class="col-md-4 d-flex justify-content-center align-items-center">
                <img src="assets/img/portfolio/funeralmass.jpg" class="card-img" alt="Image 1">
              </div>
              <div class="col-md-8">
                <div class="card-body">
                  <h5 class="card-title">Funeral Mass</h5>
                  <p class="card-text">He approached the passing of a loved one with a compassionate, guided by faith and belief in eternal life.</p>
